...
<body>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" id="abrirVenta" data-toggle="modal" data-target="#nuevaVenta"><i class="fas fa-plus fa-sm text-white-50"></i> Nueva Venta</a>
    </div>
